...
```html
<div data-pym-src="http://static.startribune.com/projects/mn-elections">Loading...</div>
...
```js
{
  "publish": {
    "default": {
      ...
      "path": "news/projects-staging/all/mn-elections/",
      "url": "http://static.startribune.com/news/projects-staging/all/mn-elections/"
    },
    "production": {
      "bucket": "static.startribune.com",
      "path": "news/projects/all/mn-elections/",
      "url": "http://static.startribune.com/news/projects/all/mn-elections/"
    }
  }
}
```
